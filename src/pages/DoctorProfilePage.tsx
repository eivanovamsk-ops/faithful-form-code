        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto items-start">
            ...
            >
              ...
              <p className="text-lg text-brand-teal font-medium mb-6">{doctor.role}</p>

              {doctor.experience && (
                <div className="inline-flex items-center gap-2 bg-brand-teal/10 text-brand-teal rounded-full px-5 py-2.5 mb-8">
              ...
              {doctor.education && (
                <div className="mb-8">
                  ...
                  {doctor.additionalEducation && (
                    <p className="text-muted-foreground/70 leading-relaxed mt-2 text-sm">{doctor.additionalEducation}</p>
                  )}
                </div>
              )}
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[1, 2, 3, 4].map(i => (
                <motion.div
                  ...
                  className="aspect-[3/4] rounded-2xl bg-background border border-border flex items-center justify-center shadow-sm"
                >
