        ...
        <div className="container mx-auto px-4 max-w-3xl">
          <div className="space-y-8 text-foreground/85 text-lg leading-relaxed">
            ...
            <div>
              ...
              <ul className="space-y-3 mb-8">
                {[
                  ...
                  renderWithLinks("Диагностика. Рекомендуя пройти тот или иной вид диагностики, врач объясняет для чего это необходимо и отвечает на все вопросы. Подробно о том какие виды обследований проводятся в стоматологии можно прочитать [здесь](/uslugi/diagnostika).") as string,
                  ...
                  <li key={i} className="flex items-start gap-3 text-base text-foreground/80">
                    ...
                    <span className="leading-relaxed">{typeof item === "string" && item.includes("[") ? renderWithLinks(item) : item}</span>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2.5 mb-8">
                {[
                  renderWithLinks("Через чат-бот [«Личный помощник»](/pacientam/loyalnost)") as string,
