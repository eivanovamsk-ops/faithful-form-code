...
const priceCategories = [
  ...
  { title: "Терапия", note: "Лечение под микроскопом с коффердамом. Длительность до 60 минут", items: [
    ...
    { name: "Герметизация фиссур", price: "от 5 300 до 6 500 ₽" },
  ...
  { title: "Хирургия. Удаление зубов", note: "Безболезненно с использованием современных анестетиков. Длительность от 1 визита", items: [
    ...
    { name: "Сложное удаление постоянного зуба", price: "от 11 000 до 17 300 ₽" },
    { name: "Удаление зуба мудрости (ретинированного/дистопированного зуба)", price: "от 19 300 до 35 600 ₽" },
    { name: "Удаление временного зуба", price: "от 2 900 до 8 500 ₽" },
    { name: "Коррекция уздечки", price: "от 10 200 до 11 700 ₽" },
